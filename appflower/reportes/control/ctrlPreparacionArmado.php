...
$reporte->setTitle("Preparación armado");


//Posicion del titulo
$reporte->setCellValue('A1', 'Preparación armado');
...
header('Content-Disposition: attachment;filename="preparacionArmado_'.$desde.'.xls"');
