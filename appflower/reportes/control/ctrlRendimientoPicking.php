...
$reporte->setTitle("Rendimientos picking");


//Posicion del titulo
$reporte->setCellValue('A1', 'Rendimientos picking');
if ($selectedOption === "1") {
...
$count = 3;
if ($selectedOption === "1") {
    $Reporte = $report->rendimientoPickingFecha($desde, $hasta);
} else {
    $Reporte = $report->rendimientoPickingSemana($Week);
}
...
header('Content-Disposition: attachment;filename="rendimientoPicking-'.$desde.'.xls"');
