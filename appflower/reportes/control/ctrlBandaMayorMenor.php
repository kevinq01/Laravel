...
$reporte->setTitle("Armado banda");


//Posicion del titulo
$reporte->setCellValue('A1', 'Rendimientos banda descendente');
...
header('Content-Disposition: attachment;filename="armadoBanda_rendimiento_'.$desde.'.xls"');
