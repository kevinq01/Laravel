...
$reporte->setTitle("Rendimientos tinturados");


//Posicion del titulo
$reporte->setCellValue('A1', 'Rendimientos tinturados');
if ($selectedOption === "1") {
...
$count = 3;
if ($selectedOption === "1") {
    $Reporte = $report->rendimientoTinturadosFecha($desde, $hasta);
} else {
    $Reporte = $report->rendimientoTinturadosSemana($Week);
}
