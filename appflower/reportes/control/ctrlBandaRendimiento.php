...
$reporte->setTitle("Rendimiento Armado Banda");

//Posicion del titulo
$reporte->setCellValue('A1', 'Rendimientos armado banda');
...
header('Content-Disposition: attachment;filename="rendimientos_armadoBanda_' . $desde . '.xls"');
