...
$reporte->setTitle("Rendimiento Armado tallo");

//Posicion del titulo
$reporte->setCellValue('A1', 'Rendimientos armado tallo');
...
header('Content-Disposition: attachment;filename="rendimientos_armadoTallo_' . $desde . '.xls"');
