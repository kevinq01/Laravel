            ...
            <div class="col vh-100 border-left">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12  col-md-12 col-lg-12 col-xl-4 mb-3 mb-sm-3 mb-md-3 mb-lg-3 mb-xl-0 pr-lg-3 pr-xl-0">
                        ...
                        <!--Search Component-->
                        <div class="card mb-3">
                            <div class="card-header text-primary"><i class="fa fa-search"></i> Buscar operario en tiempo muerto general: </div>

                            <div class="input-group">
                                <input type="text" class="form-control" id="BuscartmGeneral">
