                                ...
                                <table class="table border  table-hover">
                                    ...
                                    <tr class="">
                                        <div id="accordion">
                                            ...
                                            $Tinturados = $tinturados->listaTinturadoLimit($paginationStart, $limit);
                                            if ($Tinturados != null) {
                                            ...
                                            ?>
                                                    ...
                                                    <div class="">
                                                        <button class="btn btn-block  p-0 border bg-light rounded-0 shadow-none px-2 text-dark" data-toggle="collapse" data-target="#collapse<?php echo $Tinturados['id_tinturado'] ?>" aria-expanded="true" aria-controls="collapse<?php echo $Tinturados['id_tinturado'] ?>">
                                                            <div class="row">
                                                                <div class="col-6 d-flex">
                                                                    <?php

                                                                    //Cada labor tiene un icono definido
                                                                    switch ($Tinturados['id_labor']) {
                                                                        case '1':
                                                                    ...
                                                                    if ($Tinturados['Promedio'] > $Tinturados['rendimiento']) {
                                                                    ...
                                                                    ?>
                                                                    <div class="m-2"><i class="<?php echo $laborIcon ?> text-muted pr-1" style=""></i><?php echo $Tinturados['labor'] ?></div>
                                                                </div>
                                                    ...
                                                    <div class="collapse border border-top-0 " id="collapse<?php echo $Tinturados['id_tinturado'] ?>" data-parent="#accordion">
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item lp d-flex justify-content-between">
                                                                <div class=""><b>Labor </b>: <?php echo $Tinturados['labor'] ?></div>
                                                                <div class="text-center">
                                                                    <button class="btn  btn-sm  btn-outline-primary border-0" id="btn-editar-tinturados" value="<?php echo $Tinturados['id_tinturado'] ?>">Editar</button>
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item lp"><b>Codigo </b>: <?php echo $Tinturados['operario'] ?></li>
                                                            <li class="list-group-item lp"><b>Nombre </b>: <?php echo $Tinturados['nombre'] ?></li>
                                                            <li class="list-group-item lp"><b>Fecha </b>: <?php echo $Tinturados['fecha'] ?></li>
                                                            <li class="list-group-item lp"><b>Semana </b>: <?php echo $Tinturados['Semana'] ?></li>
                                                            <li class="list-group-item lp"><b>Tiempo </b>: <?php echo $Tinturados['horas'] ?></li>
                                                            <li class="list-group-item lp"><b>Tallos </b>: <?php echo $Tinturados['tallos'] ?></li>
                                                            <li class="list-group-item lp"><b>Promedio </b>: <?php echo $Tinturados['Promedio'] ?></li>
                                                        </ul>
                                                    </div>
                                            <?php
                                                }
